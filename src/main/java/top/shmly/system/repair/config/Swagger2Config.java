...
import top.shmly.system.repair.contant.DefContants;
...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("top.shmly.system.repair"))
...
//				.termsOfServiceUrl("NO terms of service")
                ...
                .description("后台API接口")
                // 作者
                .contact(new Contact("Jibny","https://shmly.top","zhanjibin99@gmail.com"))
